    ...
    <div id="accordian">
        <ul className="show-dropdown">
            ...
            <li>
                ...
                <ul>
                    <li><Link to="/EmBreve" className='text-light'><i className="fa fa-money"></i>Financeiro</Link></li>
            ...
            <li>
                ...
                <ul>
                    <li><Link to="/PerfilAdmin" className='text-light' id="meu-link"><i className="fa fa-user-plus"></i>Perfil</Link></li>
